...
#ifndef DDlightPhysicsList_h
#define DDlightPhysicsList_h 1

#include "globals.hh"
#include "G4VUserPhysicsList.hh"

class DDlightPhysicsListMessenger;
...
class DDlightPhysicsList : public G4VUserPhysicsList
{
  public:

    DDlightPhysicsList();
    virtual ~DDlightPhysicsList();
  ...
  private:
    ...
    DDlightPhysicsListMessenger* fMessenger;
