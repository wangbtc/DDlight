   ...
   fParticleGun(0)
{
  ...
  fGunMessenger = new DDlightPrimaryGeneratorMessenger(this);
...
void DDlightPrimaryGeneratorAction::SetOptPhotonPolar()
{
...
void DDlightPrimaryGeneratorAction::SetOptPhotonPolar(G4double angle)
{
