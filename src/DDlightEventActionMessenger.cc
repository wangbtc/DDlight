...
DDlightEventActionMessenger::DDlightEventActionMessenger(DDlightEventAction* EvAct)
:eventAction(EvAct){
...
DDlightEventActionMessenger::~DDlightEventActionMessenger() {
...
void DDlightEventActionMessenger::SetNewValue
